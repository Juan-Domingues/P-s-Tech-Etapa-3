...
-- PERFIL SOCIAL E PREVENÇÃO
CREATE OR REPLACE TABLE COVID_DATA.DADOS_TRATADOS.PERFIL_SOCIAL_E_PREVENCAO AS (
SELECT 
    UF,
    MES_REFERENCIA,
    "ESTAVA_TRABALHANDO_?",
    "QUAL_ERA_A_JORNADA_DE_TRABALHO_SEMANAL_?",
    "NA_SEMANA_PASSADA_TRABALHOU?",
    "QUAL_O_RENDIMENTO_BRUTO_MENSAL_QUE_RECEBIA_EFETIVAMENTE_?",
    "QUAIS_MEDIDAS_DE_PREVENCAO_FORAM_ADOTADAS_NO_DIA_A_DIA_?",
    "MANTEVE_DSITANCIAMENTO_DAS_PESSOAS"
FROM COVID_DATA.BIG_DATA.PNAD_COVID
WHERE 1=1
AND "PROCUROU_ATENDIMENTO?" = 1);
